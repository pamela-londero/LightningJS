 ...
 * CLI version: 2.8.1
 * 
 * Generated: Sun, 23 Oct 2022 16:16:27 GMT
 */

var APP_fetch = (function () {
  'use strict';
  ...
  var _from = "@lightningjs/sdk@^5.1.0";
  var _id = "@lightningjs/sdk@5.1.0";
  var _inBundle = false;
  var _integrity = "sha512-tRGqNNx+QVbI0gEj+9drPK6uG30tMWb08RUaddtjmJ6YlUC4f0NDW6357Pw1ntclRDns+gIjPqQq1qFIeuLqlw==";
  ...
  var _resolved = "https://registry.npmjs.org/@lightningjs/sdk/-/sdk-5.1.0.tgz";
  var _shasum = "4ddf18fc0da0bc10afd51ce89427d8aeb5b9120d";
  var _spec = "@lightningjs/sdk@^5.1.0";
  var _where = "C:\\Users\\vitta\\Documents\\Programacion\\IncluitFinalTest\\fetch";
  var bugs = {
    ...
    async addDataToScreen(url) {
      ...
      let movies = data.results.map(movie => {
        return {
          ...
          images: {
            img: "http://image.tmdb.org/t/p/w500/9Rj8l6gElLpRL7Kj17iZhrT5Zuw.jpg"
          }
        };
      });
  ...
  class Movies extends Lightning$1.Component {
    static _template() {
      return {
        Background: {
          rect: true,
